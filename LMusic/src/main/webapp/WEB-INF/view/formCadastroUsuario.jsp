...
<body class="bg-white dark:bg-slate-900 grid grid-cols-2">
    ...
    <div class="m-10">
        <h1 class="inline bg-gradient-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">Você está na página de cadastro de usuário.</h1>
        <p class="mt-3 text-2xl tracking-tight text-slate-400">Preencha os campos abaixo e em seguida confirme as informações para poder se registrar em nosso sistema.</p>
        <form action="rota" method="post" class="mt-3">
            ...
            <button type="submit" name="acao" value="registrarUsuario" class="rounded-full bg-sky-300 py-2 px-4 text-sm font-semibold text-slate-900 hover:bg-sky-200 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300/50 active:bg-sky-500 mt-3">Confirmar</button>
        </form>
    </div>
